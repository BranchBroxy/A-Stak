...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.tab.setGeometry(QtCore.QRect(0, 0, 751, 191))
        ...
        self.d_tab_browse_frame.setGeometry(QtCore.QRect(20, 10, 491, 51))
        ...
        self.d_tab_data_import_button.setGeometry(QtCore.QRect(20, 100, 131, 51))
        ...
        self.d_tab_plot_button.setGeometry(QtCore.QRect(160, 100, 131, 51))
        self.d_tab_plot_button.setObjectName("d_tab_plot_button")
        self.d_tab_checkbox = QtWidgets.QCheckBox(self.d_tab)
        self.d_tab_checkbox.setGeometry(QtCore.QRect(20, 70, 151, 23))
        self.d_tab_checkbox.setObjectName("d_tab_checkbox")
        self.tab.addTab(self.d_tab, "")
        self.stg_tab = QtWidgets.QWidget()
        self.stg_tab.setObjectName("stg_tab")
        self.stg_tab_tab = QtWidgets.QTabWidget(self.stg_tab)
        self.stg_tab_tab.setGeometry(QtCore.QRect(0, 0, 751, 171))
        self.stg_tab_tab.setObjectName("stg_tab_tab")
        self.stg_tab_ss_tab = QtWidgets.QWidget()
        self.stg_tab_ss_tab.setObjectName("stg_tab_ss_tab")
        self.stg_tab_tab.addTab(self.stg_tab_ss_tab, "")
        self.stg_tab_std_tab = QtWidgets.QWidget()
        self.stg_tab_std_tab.setObjectName("stg_tab_std_tab")
        self.comboBox = QtWidgets.QComboBox(self.stg_tab_std_tab)
        self.comboBox.setGeometry(QtCore.QRect(180, 20, 151, 31))
        self.comboBox.setObjectName("comboBox")
        self.label = QtWidgets.QLabel(self.stg_tab_std_tab)
        self.label.setGeometry(QtCore.QRect(10, 20, 171, 21))
        self.label.setObjectName("label")
        self.sta_tab_matlab_tab_auto_calc_comboBox_2 = QtWidgets.QComboBox(self.stg_tab_std_tab)
        self.sta_tab_matlab_tab_auto_calc_comboBox_2.setGeometry(QtCore.QRect(480, 20, 171, 31))
        self.sta_tab_matlab_tab_auto_calc_comboBox_2.setObjectName("sta_tab_matlab_tab_auto_calc_comboBox_2")
        self.sta_tab_matlab_tab_auto_calc_label_2 = QtWidgets.QLabel(self.stg_tab_std_tab)
        self.sta_tab_matlab_tab_auto_calc_label_2.setGeometry(QtCore.QRect(360, 20, 111, 21))
        self.sta_tab_matlab_tab_auto_calc_label_2.setObjectName("sta_tab_matlab_tab_auto_calc_label_2")
        self.sta_tab_matlab_tab_auto_calc_button_2 = QtWidgets.QPushButton(self.stg_tab_std_tab)
        self.sta_tab_matlab_tab_auto_calc_button_2.setGeometry(QtCore.QRect(480, 60, 201, 41))
        self.sta_tab_matlab_tab_auto_calc_button_2.setObjectName("sta_tab_matlab_tab_auto_calc_button_2")
        self.stg_tab_tab.addTab(self.stg_tab_std_tab, "")
        self.tab.addTab(self.stg_tab, "")
        self.sta_tab = QtWidgets.QWidget()
        self.sta_tab.setObjectName("sta_tab")
        self.sta_tab_tab = QtWidgets.QTabWidget(self.sta_tab)
        self.sta_tab_tab.setGeometry(QtCore.QRect(0, 0, 751, 171))
        ...
        self.sta_tab_matlab_tab_auto_calc_label.setGeometry(QtCore.QRect(320, 20, 111, 21))
        ...
        self.sta_tab_matlab_tab_auto_calc_comboBox.setGeometry(QtCore.QRect(440, 20, 171, 31))
        ...
        self.sta_tab_matlab_tab_auto_calc_button.setGeometry(QtCore.QRect(440, 60, 201, 41))
        ...
        self.sta_tab_elephant_tab_auto_calc_button.setGeometry(QtCore.QRect(440, 60, 201, 41))
        ...
        self.sta_tab_elephant_tab_auto_calc_comboBox.setGeometry(QtCore.QRect(440, 20, 171, 31))
        ...
        self.sta_tab_elephant_tab_auto_calc_label.setGeometry(QtCore.QRect(320, 20, 111, 21))
        ...
        self.sta_tab_astak_tab_auto_calc_button.setGeometry(QtCore.QRect(440, 60, 201, 41))
        ...
        self.sta_tab_astak_tab_auto_calc_label.setGeometry(QtCore.QRect(320, 20, 111, 21))
        ...
        self.sta_tab_astak_tab_auto_calc_comboBox.setGeometry(QtCore.QRect(440, 20, 171, 31))
        ...
        self.MainTextBrowser.setGeometry(QtCore.QRect(770, 30, 341, 161))
        ...
        self.stg_tab_tab.setCurrentIndex(0)
        ...
        self.d_tab_data_import_button.clicked.connect(partial(import_data, ui=ui))  # Laden der Datei des Pfades

        self.sta_tab_matlab_tab_feature_calc_button.clicked.connect(
            partial(matlab_calc_feature, ui=ui, all_flag=False))  # Berechnung des ausgewählten MatLab Features (combobox)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.d_tab_plot_button.setText(_translate("MainWindow", "Plote Daten"))
        self.d_tab_checkbox.setText(_translate("MainWindow", "Ordner und Datein"))
        self.tab.setTabText(self.tab.indexOf(self.d_tab), _translate("MainWindow", "Datenimport"))
        self.stg_tab_tab.setTabText(self.stg_tab_tab.indexOf(self.stg_tab_ss_tab),
                                    _translate("MainWindow", "Spike Sorting"))
        self.label.setText(_translate("MainWindow", "Detektionsalgorithmus:"))
        self.sta_tab_matlab_tab_auto_calc_comboBox_2.setStatusTip(_translate("MainWindow", "Ausgabeformat"))
        self.sta_tab_matlab_tab_auto_calc_label_2.setStatusTip(_translate("MainWindow", "Ausgabeformat"))
        self.sta_tab_matlab_tab_auto_calc_label_2.setText(_translate("MainWindow", "Ausgabeformat:"))
        self.sta_tab_matlab_tab_auto_calc_button_2.setStatusTip(
            _translate("MainWindow", "Automatisierte Berechnung durchführen"))
        self.sta_tab_matlab_tab_auto_calc_button_2.setText(_translate("MainWindow", "Automatisierte Berechnung"))
        self.stg_tab_tab.setTabText(self.stg_tab_tab.indexOf(self.stg_tab_std_tab),
                                    _translate("MainWindow", "Spike Train Detektion"))
        self.tab.setTabText(self.tab.indexOf(self.stg_tab), _translate("MainWindow", "Spike Train Generierung"))
...
if __name__ == "__main__":
    ...
    # MyPart
    initial_start(ui, MainWindow)   # Funktion die beim Start aufgerufen wird, Disablen der Analyse und Plot Tabs
    # End of MyPart
    MainWindow.show()
    sys.exit(app.exec_())
